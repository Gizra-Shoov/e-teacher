...
class FeatureContext extends MinkContext implements SnippetAcceptingContext {
   ...
   */
  public function iVisitTheStudentPersonalAreaPage() {
    $this->getSession()->visit('https://student.eteachergroup.com/Login?ReturnUrl=%2f');

    $element = $this->getSession()->getPage();
    // Add the username in the form.
    $this->iWaitForCssElement('css', '#EmailOrUsername');
    $element->fillField('EmailOrUsername', $this->user);
    // Add the password in the form.
    $this->iWaitForCssElement('css', '#Password' );
